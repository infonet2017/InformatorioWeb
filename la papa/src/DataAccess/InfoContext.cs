...
namespace DataAccess
{
    ...
    {
        public InfoContext(DbContextOptions<FileContext> options) :base(options)
        { }
        ...
        protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
        {
            ...
            optionsBuilder.UseMySql(@"server=cdbr-azure-south-b.cloudapp.net;port=3306;database=info2017;user=bc024701276aa4;password=f6faf138;");
        }
